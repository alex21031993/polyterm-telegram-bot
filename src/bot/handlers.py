...
async def cmd_help(message: Message) -> None:
    ...
    help_text = (
        ...
        "/admin - Админ-панель\n\n"
        "<b>Команды PolyTerm:</b>\n"
        "Используйте кнопки меню для доступа к функциям PolyTerm.\n\n"
        "<b>TradingAgents:</b>\n"
        "Используйте /trade <тикер> для анализа акций, криптовалют или ETF.\n"
        "Примеры: /trade AAPL, /trade BTC-USD, /trade SPY"
    )
